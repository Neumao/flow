...
import { Loader2, Plus, Eye, Ban, CheckCircle, RefreshCw, Edit, XCircle, ArrowRightLeft, Lock, Unlock, Shield, ArrowRight } from "lucide-react"
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                <div className="lg:col-span-2 space-y-4">
                                    ...
                                    <Card className="shadow-lg border-0">
                                        ...
                                        <CardContent>
                                            {detailData?.workItem?.data?.auditEvents && detailData.workItem.data.auditEvents.length > 0 ? (
                                                <ScrollArea className="h-96">
                                                    <div className="space-y-4 pr-4">
                                                        {[...detailData.workItem.data.auditEvents]
                                                            .sort((a: any, b: any) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime())
                                                            .map((event: any, index: number) => (
                                                                <div key={index} className="flex items-start space-x-3 pb-4 border-b border-gray-100 dark:border-gray-700 last:border-b-0 last:pb-0">
                                                                    ...
                                                                    <div className="flex-1 min-w-0">
                                                                        ...
                                                                        {(event.fromState || event.toState) && (
                                                                            <div className="text-xs text-gray-600 dark:text-gray-400 mb-1">
                                                                                {event.fromState && event.toState ? (
                                                                                    ...
                                                                                    <span>From: <Badge variant="outline" className="text-xs px-1 py-0">{event.fromState}</Badge></span>
                                                                                ) : event.toState ? (
                                                                                    <span>To: <Badge variant="outline" className="text-xs px-1 py-0">{event.toState}</Badge></span>
                                                                                ) : null}
                                                                            </div>
                                                                        )}
                                                                        ...
                                                                        {event.justification && (
                                                                            <div className="text-sm text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-800 p-2 rounded-md">
                                                                                {event.justification}
                                                                            </div>
                                                                        )}
                                                                    </div>
